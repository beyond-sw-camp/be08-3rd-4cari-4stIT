...
|조은희|처음으로 프론트엔드와 백엔드를 동시에 구현해 본 게 처음이라서 막히는 부분이 있었지만 <br> 팀원들의 도움으로 잘 마무리 할 수 있었습니다. 이번 프로젝트에서는 merge 할 때 생각보다 충돌이 일어나지 않아 <br> 빠르게 진행할 수 있었던 것 같습니다. 다들 고생하셨습니다 !|

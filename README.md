...
|&nbsp;&nbsp;팀&nbsp;원&nbsp;&nbsp;&nbsp;|회고록|
|:---:|---|
|김나현|저번 백엔드 프로젝트에 비해 기간이 짧고 vue나 자바 스크립트 같은 프론트 기술들에 대해 처음 접하다보니 단기간 안에 진행하기에 저 스스로에 대한 걱정도 되고 빠듯하지 않을까 걱정했습니다. 그러나 좋은 팀원들 만나서 간단하게라도 백엔드까지 구현하고 프론트와 연결하면서 좋은 경험할 수 있었습니다. 서로 도움 받으며 각자 맡은 바에 있어서 최선을 다해서 결과물을 만들어 낼 수 있어서 만족스러웠습니다! 고생 많으셨습니다!|
|이유진|이번 프로젝트를 진행하면서 프론트 프로젝트의 구조에 대해 더 잘 이해할 수 있게 되었습니다. 또한 클라이언트와 서버단까지 구현하며, 통신 흐름에 관해 더 자세히 공부하고 배워갈 수 있었습니다. 프로젝트를 통해 많이 성장해 나간 것 같습니다. 감사합니다.|
|장현준|&nbsp;|
|전현규|html, javascript, css, vue 등 프론트엔드에 필요한 기술을 배우고 사용해 보며, 실제 구현한 화면이 동작하는 것을 직접 볼 수 있는 경험을 했습니다. 대략 2주 정도의 기간 동안 팀원들과 화면을 구현 해보고 어떤 페이지에서 어떤 페이지로 이동할지, 어떻게 보이는게 더 좋을지 의견을 주고 받을 수 있는 좋은 기회가 되었던 것 같습니다.|
|조은희|&nbsp;|
